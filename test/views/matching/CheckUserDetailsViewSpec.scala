...
import assets.MessageLookup.{Base => common, ConfirmUserDetails => messages}
...
import views.html.helpers.ConfirmUserDetailsIdConstants._

class CheckUserDetailsViewSpec extends UnitTestTrait {
  ...
  lazy val postAction: Call = controllers.matching.routes.ConfirmDetailsController.submit()
  lazy val backUrl: String = "testBackUrl"

  def page(): Html = views.html.matching.check_user_details(
  ...
  "Check User Details page view" should {
